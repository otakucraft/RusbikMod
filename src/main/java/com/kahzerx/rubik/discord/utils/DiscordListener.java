...
import com.kahzerx.rubik.discord.commands.*;
...
public class DiscordListener extends ListenerAdapter {
    ...
    public DiscordListener(final MinecraftServer s) {
        server = s;
    }

    public static void connect(final MinecraftServer server, final String t, final String c) {
        token = t;
        channelId = c;
        try {
            chatBridge = false;
    ...
    public static void sendAdminMessage(final String msg) {
        if (chatBridge) {
            try {
