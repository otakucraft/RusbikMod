...
public class SBCommand {
    ...
    public static int clearSidebar(ServerCommandSource source) throws CommandSyntaxException {
        ...
        if (sc.getObjectiveForSlot(1) == null) {
            ...
            Text text = new LiteralText(String.format("%s ha eliminado el scoreboard.", source.getPlayer().getName().asString()));
    ...
    public static void initialize(ServerCommandSource source, ScoreboardObjective scoreboardObjective, Item item, String type) {
        ...
        for (File stat: stats) {
            ...
            if(player != null) {
                ...
                if(gameProfile != null) playerName = gameProfile.getName();
                else continue;
            }
